...
public class DbContext {
    ...
    public static ArrayList<Person> getPeople(){
        people.clear();
        Person person1 = new Person(0, "John", "Adam", "johnAdam");
        Person person2 = new Person(1, "Stewart", "Little", "stewLitt");
        Person person3 = new Person(2, "Nemo", "Little", "nemoLitt");
        Person person4 = new Person(3, "Jorgan", "VonStrangle", "jorgVonS");
        people.add(person1);
        people.add(person2);
        people.add(person3);
        people.add(person4);
