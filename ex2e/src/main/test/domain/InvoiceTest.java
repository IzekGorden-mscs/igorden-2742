...
//        assertFalse(this.invoice1.getDueDate() == invoice2.getDueDate());
        ...
        assertEquals(this.invoice1.getApartment(), this.apartment);
    }
...
//        assertFalse(this.invoice1.getDueDate() == invoice2.getDueDate());
    ...
    void toStringTest() {
        ...
        assertEquals("1, 2019/09/01", this.invoice1.toShortString().substring(6));
        assertEquals(
                "1001, 1, 2019/09/01",
                this.invoice1.toString().substring(0));
    }
